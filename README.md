...
The application displays a list of available stocks along with their prices in a table at the top. Users can enter a stock symbol and quantity to execute buy or sell transactions. The system updates the user's balance and portfolio accordingly.

The portfolio section shows the stocks owned by the user, including quantity and total invested amount. All data is managed using Object-Oriented Programming concepts with separate classes for stocks, users, and transactions.
...
- Portfolio tracking using JTable
...
- OOP (Stock, User, Transaction classes)
...
<img width="1920" height="1080" alt="Screenshot  (3)" src="https://github.com/user-attachments/assets/3dda2eb3-3b63-4ba1-907f-ee7d3edbfc58" />
<img width="1920" height="1080" alt="Screenshot  (2)" src="https://github.com/user-attachments/assets/b28a350e-586b-456c-b559-b3db73bf8e5b" />
